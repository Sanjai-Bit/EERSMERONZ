...
const About = () => {
  return (
    <div
      id="About"
      className="  relative max-w-[100vw] -mt-80 max-sm:-mt-0 bg-black min-h-[100vh] flex flex-col items-center gap-5 justify-center text-center"
    >
      
      <p className=" text-xl text-primary  flex items-center justify-center gap-4">
        {" "}
      ...
      <p className="  text-3xl max-sm:text-xl max-sm:w-full max-sm:px-8 w-3/5">
