...
const Highligts = () => {
  ...
  return (
    ...
    >
      ...
      <p className=" max-sm:text-xl text-3xl text max-sm:w-full max-sm:px-5 w-2/3 max-sm:-mt-5 -mt-10">
        As professionals, we recognize the pivotal role of shaping the future technology and fostering a culture of innovation
      </p>
      <div className=" grid px-20 max-sm:px-4 max-sm:grid-cols-1 grid-cols-2 gap-5">
        {some &&
          some.map((s) => {
            return (
              <div className="  bg rounded-3xl px-10 max-sm:px-5 py-10 border border-secondary/20 shadow shadow-primary/20 p-5 text-left flex flex-col items-center max-sm:items-center justify-center gap-3">
