    ...
    >
      ...
      <div className=" grid grid-cols-3 max-sm:grid-cols-1 items-center w-full justify-center gap-5">
        {Faculties &&
          Faculties.map((f) => {
            return (
              <div className=" bg rounded-3xl w-full max-sm:w-full  border border-secondary/20 shadow shadow-primary/50 flex flex-col items-center justify-center gap-3 py-10   ">
                <img
                  src={f.img}
                  className=" h-40 rounded-full object-cover overflow-hidden"
                />
                <p className=" text  max-sm:text-xl text-3xl">{f.name}</p>
                <p className=" text-primary -mt-3">{f.job}</p>
              </div>
            );
          })}
      </div>
      <br></br>
      <div className=" bg max-sm:bg-none max-sm:border-0 border border-secondary/20  shadow shadow-primary/50 w-full rounded-3xl flex flex-col items-center justify-center gap-5  py-10">
        <div className=" grid grid-cols-3   max-sm:grid-cols-1 items-center h-full justify-center max-sm:gap-2 gap-10  ">
          ...
          <div className=" flex flex-col px-5 max-sm:items-center max-sm:pt-10 h-full gap-2  w-full items-start justify-center">
            ...
            <p>Logesh R - 9361326035</p>
            <p>Kaniga B - 8438836124</p>
            <p>Surya Prakash K - 8270571779</p>
            <p>Divya Prasanna K - 9345774050</p>
          </div>
          <iframe
