   ...
   <p className=" text-primary text-xl  py-10 flex items-center justify-center gap-4">
      ...
      <div className="  grid grid-cols-3 max-sm:grid-cols-1    items-center gap-10 justify-center">
        {offer &&
          offer.map((o) => {
            return (
              <div className="  text-left w-96 max-sm:w-full max-sm:hover:scale-1   hover:ring-1 hover:ring-primary hover:scale-110 transition-all  duration-500 ease-in-out   bg-background  flex flex-col gap-5 items-start p-5 py-10 justify-start border-secondary/50 h-full     rounded-md">
                ...
                <div className=" max-sm:w-full  border border-secondary/20 shadow-xl shadow-primary/10 w-full rounded-md bg flex flex-col items-start justify-center p-5 gap-5">
